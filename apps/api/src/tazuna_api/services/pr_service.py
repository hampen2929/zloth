...
from tazuna_api.domain.enums import ExecutorType, PRUpdateMode
...
from tazuna_api.storage.dao import PRDAO, RunDAO, TaskDAO
...
class PRService:
    ...
    async def create(self, task_id: str, data: PRCreate) -> PR:
        ...
        pr_body = data.body or f"Generated by tazuna\n\n{run.summary or ''}"
...
"""
    ...
    async def _execute_for_description(
        ...
        temp_file = Path(f"/tmp/tazuna_pr_desc_{uuid.uuid4().hex}.md")
...
"""
    ...
    async def update(self, task_id: str, pr_id: str, data: PRUpdate) -> PR:
        ...
        patch_file = workspace_path / ".tazuna_patch.diff"
        try:
