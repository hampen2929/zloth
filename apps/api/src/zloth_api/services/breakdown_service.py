...
BREAKDOWN_RESULT_FILE = ".zloth-breakdown.json"
...
## Output Format
Output the result as a JSON file at `.zloth-breakdown.json`:
...
8. IMPORTANT: Create the `.zloth-breakdown.json` file with your analysis
"""
...
4. IMPORTANT: Create the `.zloth-breakdown.json` file with your analysis
"""
