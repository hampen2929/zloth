...
class GitService:
    ...
    This service handles all git operations in zloth, ensuring consistent
    behavior across different execution flows. AI Agents should only edit
    files, while zloth manages all git operations through this service.
    """
    ...
    def _normalize_branch_prefix(self, prefix: str | None) -> str:
        ...
        Rules:
        - If empty/None after trimming -> 'zloth'
        - Trim whitespace
