...
from zloth_api.domain.enums import ExecutorType, RoleExecutionStatus
from zloth_api.domain.models import RoleExecutionResult
...
if TYPE_CHECKING:
    from zloth_api.services.output_manager import OutputLine, OutputManager
