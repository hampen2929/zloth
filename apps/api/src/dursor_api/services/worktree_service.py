...
class WorktreeService:
    ...
    def _generate_branch_name(self, run_id: str, prefix: str = "dursor") -> str:
        """Generate a unique branch name for a run.

        Args:
            run_id: Run ID.
            prefix: Branch name prefix (default: "dursor").
    ...
    async def create_worktree(
        ...
        Args:
            ...
            branch_prefix: Prefix for the branch name (default: "dursor").
