...
```
apps/api/src/zloth_api/services/breakdown_service.py
```
...
```
apps/api/src/zloth_api/routes/breakdown.py
```
...
## 出力形式
以下のJSON形式で `.zloth-breakdown.json` ファイルに出力してください:
