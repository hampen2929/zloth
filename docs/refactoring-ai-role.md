...
```python
# apps/api/src/zloth_api/roles/protocol.py
...
```python
# apps/api/src/zloth_api/roles/base_service.py
...
```python
# apps/api/src/zloth_api/roles/registry.py
...
```python
# apps/api/src/zloth_api/services/my_new_role_service.py
...
```python
# apps/api/src/zloth_api/routes/my_new_role.py
...
- [Agentic Zloth](./agentic-zloth.md)
