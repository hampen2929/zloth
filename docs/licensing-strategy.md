...
移行時の注意点:
- 全コントリビューターにCLA（Contributor License Agreement）署名を依頼
- 既存コードの著作権を明確化
- 移行の告知期間を設ける
```
...
将来のライセンス変更に備え、CLAの導入を検討します。

### CLAの目的

- コントリビューターから著作権の許諾を得る
- 将来のライセンス変更を可能にする
- 法的な明確性を確保
...
```
推奨: Phase 1の後半（コントリビューターが増え始めた時点）
