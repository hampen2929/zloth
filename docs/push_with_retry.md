...
cmdline: git push -u origin dursor/dcffe73f
...
```
Pushed to branch: dursor/abc12345
```

### 正常時（リトライあり）

```
Pulled remote changes and pushed to branch: dursor/abc12345
```
